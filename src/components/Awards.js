		...
		<div class="awards">
			...
			<Container className='awards-grid'>
				<Row data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="700" className='align-items-center justify-content-center'>
					<Col className="award" xs={12} md={10} xl={5} >
						<div className='image-container'><img src={Waterloo}/></div>
						<div className='image-overlap'>
							<p class="explain">A $2000 scholarship awarded by the University of Waterloo to recognize admitted students with a 95%+ admissions average.</p>
						</div>
					...
					<Col className="award" xs={12} md={10} xl={5} data-aos="fade-up">
						<div className='image-container'>
							<img src={MVP}/>
						</div>
						<div className='image-overlap'>
							<p class="explain">The Senior Badminton MVP Award is given to the recipient who performed at the highest level during the competitive season. I won the Mixed Doubles event in the 2021-2022 season and the Girls Doubles event in the 2022-2023, qualifying myself for OFSAA both years.</p>
						</div>
						<div className='description'>
				...
				<Row data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="700" className='align-items-center justify-content-center'>
					...
					<Col className="award" xs={12} md={10} xl={5}>
						...
						<div className='image-overlap'>
							<p class="explain">The Ontario Winter Games is the largest multi-sport event in the province and feature over 3,500 athletes, coaches, managers, and major officials. I competed as a badminton athlete representing Team Ottawa.</p>
						</div>
						<div className='description'>
							<h2>OWG 2nd Place</h2>
				...
				<Row data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="700" className='align-items-center justify-content-center'>
					<Col className="award" xs={12} md={10} xl={5}>
						...
						<div className='image-overlap'>
							<p class="explain">A prestigious award given to the team who created the most innovative project that improves physical, mental and social well-being during LunarHacks II.</p>
						</div>
						<div className='description'>
					...
					<Col className="award" xs={12} md={10} xl={5}>
						...
						<div className='image-overlap'>
							<p class="explain">Athlete of the Year recognizes the player who has accumulated the most ranking points throughout the competitive season in the singles, doubles, and mixed doubles events combined.</p>
						</div>
						<div className='description'>
