			...
			<Container>
				<Row className="align-items-center p-5">
					...
					<Col className="text-center text-md-start justify-content-center" xs={12} md={6} xl={6}>
						...
						<a data-aos="fade-in" data-aos-delay="2000" href="mailto:y84huang@uwaterloo.ca">   <Envelope />: y84huang@uwaterloo.ca</a>
						<a data-aos="fade-in" data-aos-delay="2000" href="https://www.linkedin.com/in/yiyanhh23/">   <Linkedin />: yiyanhh23</a>
					</Col>
				</Row>
			</Container>
		</section>
